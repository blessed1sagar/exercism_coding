...
def approx_average_is_average(hand):
    ...
    median_calc = int(len(hand)/2)
    median_value = hand[median_calc]
    
    if average == first_and_last_avg or average == median_value:
        return True
    return False
...
def average_even_is_average_odd(hand):
    ...
    if average == even_average and average == odd_average:
        return True
    return False
